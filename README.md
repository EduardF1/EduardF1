**Eduard Fischer-Szava**, Aarhus, Denmark. Full-stack and platform engineer, C#/.NET and TypeScript.
...
Most of my current code is private by choice: OmniControl (the control surface described below), the estate itself, and a 2021 learning archive of 56 self-study projects. Two repositories from the VIA years are public: [`viauc-dai1-s22`](https://github.com/EduardF1/viauc-dai1-s22) and [`Android_Exam_Practice`](https://github.com/EduardF1/Android_Exam_Practice).
